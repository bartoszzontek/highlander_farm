...
class CowAdmin(admin.ModelAdmin):
    ...
    search_fields = ['tag_id', 'name', 'passport_number'] 
    ordering = ['tag_id']
    ...
    fieldsets = (
        ...
        ('Szczegóły', {
            'fields': ('birth_date', 'gender', 'breed', 'color', 'passport_number', 'photo')
        }),
        ('Dane Hodowlane', {
            'classes': ('collapse',),
        ...
        ('Zarządzanie', {
            'classes': ('collapse',),
            'fields': ('relocation_status', 'duplicates_to_make', 'duplicates_to_order', 'relocation_after_drive', 'business_number')
        }),
        ('Dane Wyjścia', {
            'classes': ('collapse',), 
